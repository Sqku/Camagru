...
ALTER TABLE `commentaires` DROP FOREIGN KEY `fk_commentaires_images1`; ALTER TABLE `commentaires` ADD CONSTRAINT `fk_commentaires_images1` FOREIGN KEY (`images_id`) REFERENCES `images`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE `likes` DROP FOREIGN KEY `fk_likes_images1`; ALTER TABLE `likes` ADD CONSTRAINT `fk_likes_images1` FOREIGN KEY (`images_id`) REFERENCES `images`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION; ALTER TABLE `likes` DROP FOREIGN KEY `fk_likes_users1`;
ALTER TABLE `likes` ADD CONSTRAINT `fk_likes_users1` FOREIGN KEY (`users_id`) REFERENCES `users`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
